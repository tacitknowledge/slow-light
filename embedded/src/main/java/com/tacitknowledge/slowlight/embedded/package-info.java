 ...
 *
 *
 * The DegradationProxyHandler uses the strategy and a threadpool to submit Callables to the threadpool.  These
 ...
 * @see com.tacitknowledge.slowlight.embedded.DegradationCallable
 * @see com.tacitknowledge.slowlight.embedded.DegradationStrategy
 * @see com.tacitknowledge.slowlight.embedded.DegradationPlan - a DTO like object containing results of applying specific strategy rules for a specific call
 *
 ...
 *
 * @see com.tacitknowledge.slowlight.embedded.DefaultDegradationStrategy
 *
 */
