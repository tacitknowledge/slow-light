...
public class DelayChannelHandlerTest extends BaseChannelHandlerTest
{
            ...
            IllegalAccessException
    {
        ...
        firstFunctionConfig.setType("com.tacitknowledge.slowlight.proxyserver.handler.TestFunction1");
        ...
        secondFunctionConfig.setType("com.tacitknowledge.slowlight.proxyserver.handler.TestFunction2");
        ...
        final DelayChannelHandler delayChannelHandler = new DelayChannelHandler(handlerConfig1);

        delayChannelHandler.evaluateBehaviorFunctions();

        Field field = delayChannelHandler.getClass().getSuperclass().getDeclaredField("handlerParams");
        field.setAccessible(true);
        MapConfiguration handlerParamsMap = (MapConfiguration) field.get(delayChannelHandler);
        ...
        handlerParamsMap = (MapConfiguration) field.get(delayChannelHandler);
